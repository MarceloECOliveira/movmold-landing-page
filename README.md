...
* **[Supabase](https://supabase.com/)**: Backend as a Service (BaaS). Utilizado especificamente com *Edge Functions* para o disparo seguro de e-mails de contato.
* **[Lucide React](https://lucide.dev/)**: Biblioteca de ícones.
* **[Prettier](https://prettier.io/)**: Padronização e formatação automática de código.